...
'''
Reads in list of g-stars, does some selection, then outputs:
...
3. pickled star list (do I use this anywhere?)
4. xyzw ascii file for correlation function
5. ascii file containing all coordinates (used in mcmc/jackknife)
'''
