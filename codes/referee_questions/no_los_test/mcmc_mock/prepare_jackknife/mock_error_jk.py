...
def main():
    ...
    data_filename   = mock_dir + 'mock.xyz.dat'
    counts_filename = data_dir + 'mock_jk_all.counts.dat'
    ...
    for i in range(N_jackknife):
        jackknife_filename = data_dir + 'mock_jk_' + str(i) + '.dat'
        counts_filename = data_dir + 'mock_jk_' + str(i) + '.counts.dat'
    ...
    output_filename = data_dir + 'mock_jk_error.dat'
