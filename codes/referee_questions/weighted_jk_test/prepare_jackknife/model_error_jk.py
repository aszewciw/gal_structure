...
def main():
    ...
    for p in todo_list:
        ...
        data_filename = data_dir + 'MWM_type' + str(model) + '_' + p.ID + '.xyzw.dat'
        ...
        for i in range(N_jackknife):
            jackknife_filename = ( data_dir + 'MWM_type' + str(model) + '_'
                + p.ID + '_jk_' + str(i) + '.dat' )
            counts_filename = ( data_dir + 'MWM_type' + str(model) + '_' + p.ID
        ...
        output_filename = ( data_dir + 'MWM_type' + str(model) + '_' + p.ID
            + '_jk_error.dat' )
