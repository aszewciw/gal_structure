...
rawdata_dir  = '../../data/'
pairs_dir    = '../pair_count_fid_A/data/'
plots_dir    = './plots/'
modA_err_dir = '../../1000_mocks_cut/errors_pairs/data/mean_var_std/'
modB_err_dir = '../../real_sigmas_compare/1000_mocks_1/errors_pairs/data/mean_var_std/'
modC_err_dir = '../../real_sigmas_compare/1000_mocks_2/errors_pairs/data/mean_var_std/'
dd_dir       = '../pair_count_truths/data/'
