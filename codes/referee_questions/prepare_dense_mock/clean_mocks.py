...
def main():
    ...
    star_factor = int(args_array[1])    # N_mock / N_segue
    ...
    for i in range(N_pointings):
        ...
        line_prepender(out_file, str(int(N_desired)))
