...
def main():
    ...
    for k in range(len(z0_thin)):
        ...
        plt.scatter(z0[k], chi2_uni_frac[k], marker='o', color='cyan', markersize=15)
        plt.plot(z0, chi2_nonuni_frac, marker='^', color='green', label='nonuniform')
        plt.scatter(z0[k], chi2_nonuni_frac[k], marker='o', color='cyan', markersize=15)
        ...
        plt.scatter(z0[k], chi2_uni[k], marker='o', color='cyan', markersize=15)
        plt.plot(z0, chi2_nonuni, marker='^', color='green', label='nonuniform')
        plt.scatter(z0[k], chi2_nonuni[k], marker='o', color='cyan', markersize=15)
        plt.plot(z0, chi2_true, marker='s', color='red', label='true')
        plt.scatter(z0[k], chi2_true[k], marker='o', color='cyan', markersize=15)
        plt.legend(numpoints=1, loc='upper left')
        plt.tight_layout()
