...
def main():
    ...
    ax1.set_title('Comparing Landy-Szalay to Peebles-Hauser')
    ax1.set_xscale('log')
    ax2.set_xscale('log')
    ...
    for p in todo_list:
        ...
        LS_corr       = np.genfromtxt(LS_file, unpack=True, usecols=[1])
    ...
    Diff_stats          = corrdata_dir + 'Difference_stats.dat'
    LS_stats            = corrdata_dir + 'LS_stats.dat'
    NE_stats            = corrdata_dir + 'NE_stats.dat'
