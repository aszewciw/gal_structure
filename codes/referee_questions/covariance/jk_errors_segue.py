...
def main():
    ...
    for ID in ID_list:
        ...
        counts_filename = segue_dir + 'star_all_counts_' + ID + '.dat'
    ...
    plt.title('Average Correlation Matrix Across l.o.s. (jk segue)', fontsize=20)
    plt.xlabel('Bin Center (kpc)', fontsize=18)
    plt.ylabel('Bin Center (kpc)', fontsize=18)

    plt.savefig('jk_data_corr_matrix.png')
