...
def main():
    ...
    # load bin settings
    # input_filename = jk_data_dir + 'rbins.dat'
    # sys.stderr.write('Loading from file {} ...\n'.format(input_filename))
    # input_file     = open(input_filename, 'rb')
    ...
    bins_filename = jk_data_dir + 'rbins.ascii.dat'

    for p in todo_list:
        # counting pairs for the whole box
        data_filename   = './' + out_path + '/uniform_' + p.ID + '_jk_all.dat'
        counts_filename = './' + out_path + '/uniform_' + p.ID + '_jk_all.counts.dat'
        ...
        for i in range(N_jackknife):
            jackknife_filename = './' + out_path + '/uniform_' + p.ID + '_jk_' + str(i) + '.dat'
            counts_filename    = './' + out_path + '/uniform_' + p.ID + '_jk_' + str(i) + '.counts.dat'
        ...
        output_filename = './' + out_path + '/uniform_' + p.ID + '_jk_error.dat'
