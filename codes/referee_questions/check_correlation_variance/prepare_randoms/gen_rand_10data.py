...
def main():
    ...
    for p in corr_list:
        ...
        # # pickle output
        # output_filename = data_dir + 'uniform_10data_' + p.ID + '.dat'
        # output_file     = open(output_filename, "wb")
        # pickle.dump(random_sample, output_file)
        # output_file.close()

        # output ascii format
        output_filename = data_dir + 'uniform_10data_' + p.ID + '.ascii.dat'
        ...
        # output xyzw
        output_filename = data_dir + 'uniform_10data_' + p.ID + '.xyz.dat'
        output_file = open(output_filename, "w")
        # first output the total number of points
        output_file.write('{}\n'.format(len(random_sample)))
        for i in random_sample:
