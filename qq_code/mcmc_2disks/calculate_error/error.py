...
def main():
    ...
    for p in todo_list:
        ...
        data_filename = config.data_dir + 'star_' + p.ID + '_jk_all.dat'
        counts_filename = config.data_dir + 'star_' + p.ID + '_jk_all.counts.dat'
        ...
        for i in range(config.N_jackknife):
            jackknife_filename = config.data_dir + 'star_' + p.ID + '_jk_' + str(i) + '.dat'
            counts_filename = config.data_dir + 'star_' + p.ID + '_jk_' + str(i) + '.counts.dat'
        ...
        output_filename = config.data_dir + 'star_' + p.ID + '_jk_error.dat'
