...
def main():
    ...
    bins_filename = config.bins_dir + 'rbins.ascii.dat'

    for p in todo_list:
        # counting pairs for the whole box
        data_filename = config.jk_dir + 'star_' + p.ID + '_jk_all.dat'
        counts_filename = config.jk_dir + 'star_' + p.ID + '_jk_all.counts.dat'
        ...
        for i in range(config.N_jackknife):
            jackknife_filename = config.jk_dir + 'star_' + p.ID + '_jk_' + str(i) + '.dat'
            counts_filename = config.jk_dir + 'star_' + p.ID + '_jk_' + str(i) + '.counts.dat'
        ...
        output_filename = config.jk_dir + 'star_' + p.ID + '_jk_error.dat'
